...
category_map = {'Car': 'Car', 'Van': 'Car', 'Truck': 'Big Vehicle', 'Bus': 'Big Vehicle', 'Pedestrian': 'Pedestrian', 'Cyclist': 'Cyclist', 'Motorcyclist': 'Cyclist', 'Tricyclist': 'Cyclist', 'Trafficcone': 'Trafficcone', 'Unknown_unmovable': 'Unknown_unmovable', 'Barrow': 'Cyclist', 'Unknowns_movable': 'Unknowns_movable', 'Triangle plate': 'Triangle plate'}
...
def convert_label(src_label_file, dest_label_file):
    ...
    for line in lines:
        ...
        # label[15] = str(round(float(label[15]), 2))
